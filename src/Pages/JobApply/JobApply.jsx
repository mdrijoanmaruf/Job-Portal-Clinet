  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to={`/jobs/${jobId}`} className="inline-flex items-center gap-2 text-[#006A71] font-medium mb-6 group hover:underline">
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-1/3 bg-gray-50 p-4 rounded-lg self-start">
                <h3 className="text-md font-semibold text-gray-900 mb-3">Application Tips</h3>
