...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-[#F2EFE7]/50 to-white overflow-hidden relative">
      {/* Background decoration */}
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-[#9ACBD0]/10 rounded-full blur-3xl"></div>
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#48A6A7]/10 rounded-full blur-3xl"></div>
      
      {/* Left side - Brand/Image */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#006A71] to-[#48A6A7] p-12 flex-col justify-center items-center text-white relative overflow-hidden shadow-2xl">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-10 left-10 w-32 h-32 bg-white/10 rounded-full"></div>
          <div className="absolute bottom-10 right-10 w-40 h-40 bg-white/10 rounded-full"></div>
          <div className="absolute top-1/3 right-10 w-20 h-20 bg-white/10 rounded-full"></div>
        </div>
          ...
          >
            <div className="flex items-center space-x-4 bg-white/10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-[#9ACBD0]">Apply to multiple jobs with a single click</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 bg-white/10 p-4 rounded-xl backdrop-blur-sm">
              ...
              <div>
                ...
                <p className="text-[#9ACBD0]">Monitor status and get timely updates</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 relative z-10">
        <motion.div 
          ...
          className="w-full max-w-md space-y-8 bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-xl border border-gray-100"
        >
          ...
          <div className="my-6 flex items-center justify-center">
            ...
            <span className="px-4 text-sm text-gray-500 whitespace-nowrap font-medium">or continue with</span>
            <span className="h-px bg-gray-200 w-full"></span>
          </div>
